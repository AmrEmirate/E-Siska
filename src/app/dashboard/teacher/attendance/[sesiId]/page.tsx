      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            {session.kelas.namaKelas} • Pertemuan {session.pertemuanKe} •{" "}
            {format(new Date(session.tanggal), "d MMMM yyyy", {
              locale: idLocale,
            })}
          </p>
        </div>
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-center gap-2">
                    <StatusButton
                      ...
                      type="HADIR"
                      onClick={() =>
                        handleStatusChange(student.siswaId, "HADIR")
                      }
                    />
                    <StatusButton
                      ...
                      type="SAKIT"
                      onClick={() =>
                        handleStatusChange(student.siswaId, "SAKIT")
                      }
                    />
                    <StatusButton
                      ...
                      type="IZIN"
                      onClick={() =>
                        handleStatusChange(student.siswaId, "IZIN")
                      }
                    />
                    <StatusButton
                      ...
                      type="ALPHA"
                      onClick={() =>
                        handleStatusChange(student.siswaId, "ALPHA")
                      }
                    />
                  </div>
                </td>
...
function StatusButton({
  ...
  const getStyle = () => {
    ...
    switch (type) {
      case "HADIR":
        return "bg-green-600 border-green-600 text-white ring-2 ring-green-100";
      case "SAKIT":
        return "bg-yellow-500 border-yellow-500 text-white ring-2 ring-yellow-100";
      case "IZIN":
        return "bg-blue-600 border-blue-600 text-white ring-2 ring-blue-100";
      case "ALPHA":
        return "bg-red-600 border-red-600 text-white ring-2 ring-red-100";
      default:
        return "";
    }
  };
