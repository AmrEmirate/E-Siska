  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Pantau perkembangan akademikmu di sini.</p>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h3 className="font-semibold text-gray-900">Ujian Tengah Semester</h3>
                <p className="text-sm text-gray-500 mt-1">Jadwal UTS akan dimulai pada tanggal 10 Desember 2024.</p>
                <div className="mt-2 text-xs text-gray-400">2 hari yang lalu</div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h3 className="font-semibold text-gray-900">Libur Nasional</h3>
                <p className="text-sm text-gray-500 mt-1">Sekolah libur pada tanggal 25 Desember 2024.</p>
                <div className="mt-2 text-xs text-gray-400">5 hari yang lalu</div>
              </div>
            </div>
          </CardContent>
        </Card>
...
function DashboardCard({ title, icon, description, href, color }: { 
  title: string, 
  ...
  return (
    <Link href={href} className="block group">
      <div className={`p-6 rounded-xl border transition-all hover:shadow-md ${color}`}>
