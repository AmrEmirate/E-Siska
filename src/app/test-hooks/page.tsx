    ...
    const runTests = async () => {
      ...
      try {
        ...
        setTestResults((prev) => ({
          ...
          tingkatan: {
            status: "✅",
            count: tingkatan.data.length,
            loading: tingkatan.loading,
          },
        }));
      } catch (error) {
        setTestResults((prev) => ({
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>✨ Tips:</strong> Check the browser console for detailed
            logs. Open Network tab in DevTools to see API requests.
          </p>
        </div>
      </div>
    </div>
