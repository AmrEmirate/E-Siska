...
export default function GenerateReportPage() {
  ...
  useEffect(() => {
    // Get kelasId from penempatan for wali
      ...
      {selectedStudentData && (
        <div className="card p-8 mb-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-semibold text-gray-900">{selectedStudentData.nama}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">NIS</p>
                <p className="font-semibold text-gray-900">{selectedStudentData.nis}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Tahun Ajaran</p>
                <p className="font-semibold text-gray-900">{activeTahunAjaran?.tahun || "-"}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Semester</p>
                <p className="font-semibold text-gray-900">{activeTahunAjaran?.semester || "-"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 italic">Data nilai akan dimuat dari sistem saat rapor di-generate.</p>
          </div>
        </div>
      )}
